<script lang="ts">
  ...
  let errorMessage = ''
  let items: Item[] = []
  const slipId: any = $page.params.slipId;
...
const slipId: string = $page.params.slipId;
selectedProduct = items.find((slippers) => slippers.id === parseInt(slipId)) || null
    } catch {
    ...
    <div class="w-full md:w-1/2 mt-4 md:mt-0">
      ...
      <div class="p-6 my-4 border border-gradient-purple-blue">
            ...
            <DropdownMenu.Content class="w-56">
              <DropdownMenu.Label>
                ...
                <span class="font-light">
                  ...
                  <span class="text-blue-500 font-bold">Read more about our return policy</span>
                </span>
              </DropdownMenu.Label>
        ...
        <h1 class="text-gray-900 my-3 text-md">
          Qty
          <select bind:value={selectedQuantity} class="border rounded-md p-1">
      ...
      {:else if selectedProduct.status === "Sold out"}
