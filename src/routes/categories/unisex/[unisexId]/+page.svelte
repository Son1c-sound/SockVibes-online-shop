<script lang="ts">
    ...
    async function loaditems() {
      ...
      const unisexId: string = $page.params.unisexId;
  
      selectedProduct = items.find((men) => men.id === parseInt(unisexId)) || null;
    }
  ...
  {#if selectedProduct}
    <div class="flex flex-col mx-4 md:mx-20 md:flex-row md:space-x-8">
      ...
      <div class="w-full md:w-1/2 mt-4 md:mt-0">
        ...
        {:else}
          <Badge class="rounded-none bg-red-500 text-white">Sold out</Badge>
        {/if}
