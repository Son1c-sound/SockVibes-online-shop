<script lang="ts">
  ...
  import { sale } from "../products"; // Importing products from external file
  ...
  const selectedProduct:any = sale.find(m => m.id === parseInt(saleId));
...
<a href="/categories/Sales" class="text-blue-600 underline" ><i class="mx-6 fa-solid fa-chevron-left "></i>Go back to Sales</a>
