...
<div class="flex flex-col mx-10 md:flex-row md:space-x-8 my-24">
    ...
    <div class="w-full md:w-1/2">
        <div class="grid grid-cols-2 gap-4">
            ...
            <div class="relative overflow-hidden rounded-lg aspect-w-1 aspect-h-1">
                <img src={item} alt={selectedProduct.name} class="object-cover w-full h-full rounded-lg" />
            </div>
            {/each}
        </div>
    </div>
    ...
    <div class="w-full md:w-1/2 mt-4 md:mt-0">
        ...
        <Select.Root>
          ...
          <div >
                <Button class='lg:w-1/4 md:w-1/2 text-xl my-10'>
                    Add to Cart
                </Button>
                <Button class='lg:w-1/4 md:w-1/2 text-xl my-10'>
                    Buy now
                ...
                <br>
                <Button class='bg-gray-100 text-black hover:text-white'>Contact Support</Button>
