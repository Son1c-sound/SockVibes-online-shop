...
<div class="relative">
  <div class="absolute left-6 bottom-3">
    <p class="flex h-1 w-1 items-center justify-center rounded-full bg-red-500 p-3 text-xs text-white">{$addnumber}</p>
  </div>
  <svg xmlns="http://www.w3.org/2000/svg" height="28px" viewBox="0 -960 960 960" width="40px" fill="#000000">
